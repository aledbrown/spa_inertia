                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-6 space-x-2">
                                    <Link :href="route('products.edit', product.id)" class="btn btn-primary btn-outline text-white">Edit</Link>
                                    <Link :href="route('products.index')" class="btn btn-secondary btn-outline">Cancel</Link>
                                </div>
                            </div>
                        </div>
                    </div>
